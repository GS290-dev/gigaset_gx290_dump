...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_HAL_LENS CUSTOM_KERNEL_LENS BOOT_LOGO MTK_PLATFORM CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
...
CUSTOM_HAL_IMGSENSOR = imx214_mipi_raw ov8856_mipi_raw
#prize fengshangdong modify
...
CUSTOM_KERNEL_IMGSENSOR = imx214_mipi_raw ov8856_mipi_raw
...
CUSTOM_MODEM = k605q2a-LWTG_R2_6763-3M-G4W18F1357820-V0.03
...
# prize add by mhy, modified for p ota q, 20200330 begin
MICROTRUST_OTA_SUPPORT = yes
# prize add by mhy, modified for p ota q, 20200330 end
MNTL_SUPPORT = no
...
#prize-modify by lanwm disenable CAT set in oversea branch,20191031-start
MTK_CTA_SET = no
#prize-modify by lanwm disenable CAT set in oversea branch,20191031-end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#prize-modify by lanwm,open persist patition-begin
#MTK_PERSIST_PARTITION_SUPPORT = yes
#prize-modify by lanwm,open persist patition-end
...
#prize-modify by lanwm enable mtklog in user mode-begin
MTK_LOG_CUSTOMER_SUPPORT = yes
#prize-modify by lanwm enable mtklog in user mode-end
...
#prize-modify by lanwm set privacy protection lock to no in oversea branch,20191031-start
MTK_PRIVACY_PROTECTION_LOCK = no
#prize-modify by lanwm set privacy protection lock to no in oversea branch,20191031-end
...
#prize modified by lanwm,enable signature-20191008-begin
MTK_SIGNATURE_CUSTOMIZATION = yes
#prize modified by lanwm,enable signature-20191008-end
...
#prize-modify by lanwm set operator to NONE in oversea branch,20191031-start
OPTR_SPEC_SEG_DEF = NONE
#prize-modify by lanwm set operator to NONE in oversea branch,20191031-end
SIM_ME_LOCK_MODE = 0
...
#屏幕密度
PRIZE_LCD_DENSITY=320
#prize add by lipengpeng 20191218 start
#指纹
PRIZE_FINGER_PRINT = sw_tee_none_android9
MICROTRUST_FINGERPRINT_SUPPORT=yes
#prize add by lipengpeng 20191218 end
ST_NFC_CHIP_VERSION=ST21NFCD

PRIZE_HW_STEP_COUNTER_FOR_GMS = yes
#---------------------------工厂测试----------------------------------
...
PRIZE_OTG_TEST = yes
#添加EMMC测试
#PRIZE_PCBA_CLEAR_TEST = 10
#频段配置根据MTK_PROTOCOL1_RAT_CONFIG 系统频段配置
...
PRIZE_64B_PROJECT=yes
#添加dram测试apk
PRIZE_TEST_DRAM_APP = no
#副麦克风
PRIZE_DUAL_MIC_SUPPORT=no
#真双摄副后摄测试项
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB=no
#prize  add  for main-3 by penggy    20190318-begin
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB2=no
#prize  add  for main-3 by penggy    20190318-end
#8804 TEE环境,指纹测试 1 设置密码生成Token, 0 固定Token
PRIZE_FINGERPRINT_MODULE  = 1
#
PRIZE_DOUJIA_DOG_FREE = yes
#---------------------------------工厂测试--------------------------------------